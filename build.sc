...
object `mill-cross-spark` extends ScalaModule with PublishModule {
  ...
  override def pomSettings = PomSettings(
    ...
    url = "https://www.github.com/nvander1/mill-cross-spark",
    licenses = Seq(License.MIT),
    versionControl = VersionControl.github("nvander1", "mill-cross-spark"),
    developers = Seq(
